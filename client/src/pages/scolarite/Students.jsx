...
const Students = ({ Layout }) => {
    ...
    const handleDelete = async (student) => {
        if (!window.confirm(`Êtes-vous sûr de vouloir supprimer ${student.firstName} ${student.lastName} et tous ses documents ?`)) {
            return;
        }
                ...
                >
                    <div>
                        ...
                        <p className="students-subtitle">
                            Service Scolarité - Archivage numérique
                        </p>
                    </div>
                </motion.div>
                            ...
                            <tbody className="students-table-body">
                                <AnimatePresence>
                                    {students.map((student, index) => (
                                        ...
                                        >
                                            <td>
                                                <span className="students-matricule">
                                                    {student.matricule}
                                                </span>
                                            </td>
                                            <td>
                                                    ...
                                                    {isAdmin && (
                                                        <>
                                                            ...
                                                            <button
                                                                ...
                                                                className="students-action-btn students-action-btn--delete"
                                                                title="Supprimer"
                                                            >
                                                                <Trash2 size={18} />
                                                            </button>
