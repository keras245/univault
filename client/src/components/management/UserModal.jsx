...
import { X, User, Mail, Building2, Lock, Eye, EyeOff, UserPlus, Save } from 'lucide-react';
...
const UserModal = ({ isOpen, onClose, user = null, onSuccess }) => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            if (isEditMode) {
                await usersAPI.update(user._id, dataToSend);
                        ...
                        <div className="modal-header-content">
                            ...
                            <div className="modal-header-text">
                                ...
                                <p className="modal-subtitle">
                                    {isEditMode ? 'Modifier les informations du compte' : 'Ajouter un nouveau compte utilisateur'}
                                </p>
                            </div>
                        </div>
                    ...
                    <form onSubmit={handleSubmit} className="modal-form">
                        <div className="modal-section">
                            ...
                            <Input
                                ...
                                type="email"
                                name="email"
                                placeholder="utilisateur@unc.edu"
